...
$con = mysqli_connect($server, $username, $pass, $database);
    ...
    if (!$con){
        ...
        if(isset($_POST["name"])){
            ...
            $emailAddressvalue= $_POST["eaddress"];
            $Phonevalue= $_POST["phone"];
            $streetvalue= $_POST["street"];
            $cityvalue= $_POST["city"];
            $statevalue= $_POST["state"];
            $zipvalue= $_POST["zip"];
            $days_attendingvalue= $_POST["day"];
            $activites_attendingvalue= $_POST["activity"];
            


             $sql = "INSERT INTO INFO (Name,  Email_Address , Phone , Street , City , STATE, Zip , Days_Attending , Activites_Attending ) 
             VALUES 
             ('$namevalue', '$emailAddressvalue', '$Phonevalue', '$streetvalue', ' $cityvalue', '$statevalue', '$zipvalue', '$days_attendingvalue', ' $activites_attendingvalue' )";
    ...
    <div class="testbox">
      <form action="new.php" method="post">
        ...
        <div class="colums">
          ...
          <div class="item">
            <label for="eaddress">Email_Address<span>*</span></label>
